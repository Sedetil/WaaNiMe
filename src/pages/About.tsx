...
const sections = [
  {
    title: 'About',
    title2: "What's WaaNiMe?",
    content: (
      <Paragraph>
        WaaNiMe is an anime streaming site where you can watch anime online in HD
...
function About() {
  useEffect(() => {
    ...
    document.title = 'About | WaaNiMe'; // Set the title when the component mounts
    return () => {
